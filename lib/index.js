...
var Accordion = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", { className: "accordion", children: [jsxRuntime.jsxs("div", { className: "accordion-header ".concat(!isExpended ? "" : "active", " ").concat(icon ? "accordion-left--icon" : ""), onClick: onClick, children: [icon &&
                        jsxRuntime.jsx("div", { className: "accordion-headaer__icon", children: icon }), jsxRuntime.jsx("h3", { className: "accordion-header__title", children: accordionHeader }), jsxRuntime.jsx(ChevronDown$1, { size: "16" })] }), jsxRuntime.jsx("div", { className: "accordion-body ".concat(!isExpended ? "collapsed" : ""), children: jsxRuntime.jsx("div", { className: "accordion-body_content", children: children }) })] }));
};
...
var Dropdown = React.forwardRef(function (props, customRef) {
    var _a;
    ...
    return open ? (jsxRuntime.jsx(Portal, { children: jsxRuntime.jsx("div", { ref: dropdownRef, className: classnames((_a = {
                    "pixel-dropdown": true,
                    "position-fixed": true
                },
...
var Actionlist = React.forwardRef(function (props, ref) {
    ...
    var actionlistRef = React.useRef(null);
    ...
    return (jsxRuntime.jsxs("div", { ref: actionlistRef, id: "".concat("jiffyui-Actionlist" + rId), className: "pixel-actionlist inline-flex", children: [activator, jsxRuntime.jsx(Dropdown, { open: open, ref: actionlistRef, padding: 8, direction: direction, onOutsideClick: handleOutsideClick, children: options === null || options === void 0 ? void 0 : options.map(function (items, groupIndex) {
                    var _a;
                    return (jsxRuntime.jsxs("div", { id: items.id, className: "jiffyui-item__container", children: [items.title && (jsxRuntime.jsx("span", { className: "jiffyui-actionlist__title line-height-18", children: items.title })), jsxRuntime.jsx("ul", { children: (_a = items.items) === null || _a === void 0 ? void 0 : _a.map(function (item, index) {
                                    return (jsxRuntime.jsx("li", { role: "none", className: "jiffyui-actionlist__item c-pointer p-8 ".concat(item.destructive ? "actionlist__item--destructive" : "", " ").concat(item.isDisabled ? "actionlist__item--disabled" : ""), id: item.id, onClick: function () {
                                            if (item.isDisabled)
                                                return;
                                            !item.isDisabled && item.onClick();
                                            handleClose();
                                        }, children: jsxRuntime.jsxs("div", { className: "jiffyui-actionlist_item__prefix__suffix", children: [item.prefixIcon && jsxRuntime.jsx("div", { className: "jiffyui-actionlist_item__prefix--icon", children: item.prefixIcon }), jsxRuntime.jsxs("div", { className: "jiffyui-actionlist_item__label--description", children: [jsxRuntime.jsx("span", { className: "jiffyui-actionlist_item__label", children: item.content }), item.description && jsxRuntime.jsx("p", { className: "jiffyui-actionlist_item_description", children: item.description })] }), item.suffixIcon && jsxRuntime.jsx("div", { className: "jiffyui-actionlist_item__suffix--icon", children: item.suffixIcon })] }) }, index));
                                }) })] }, groupIndex));
                }) })] }));
});
...
var Spinner = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", { className: "spinner ".concat(spinnerSize, " ").concat(labelPosition1, " ").concat(spinnerColor), children: [jsxRuntime.jsx("div", { className: "spinner-circle" }), label && jsxRuntime.jsx("label", { className: "spinner-label", children: label })] }));
};
...
var Button = React.forwardRef(function (_a, ref) {
    ...
    return (jsxRuntime.jsxs("button", { ref: ref, className: "btn ".concat((icon && alignIcon === "Right") ? "iconAlign-right" : "").concat(!children ? "icononly-btn" : "", " ").concat(ButtonVarent, " ").concat(ButtonSize, " ").concat(ButtonColor, " ").concat(icon ? "btn-icon" : "", " ").concat(isDisabled ? "btn-disabled" : "", " ").concat(isLoading ? "btn-loading" : "", " ").concat(isFullWidth ? "btn-full" : ""), onClick: isDisabled ? function () { } : props.onClick, children: [icon && jsxRuntime.jsx("div", { className: "btn-icon", children: icon }), isLoading && (jsxRuntime.jsx("div", { className: "btn-loader__overlay", children: jsxRuntime.jsx(Spinner, { size: SpinnerSize, label: "" }) })), children && jsxRuntime.jsx("span", { className: "btn-text", children: children })] }));
});
...
var TextLink = React.forwardRef(function (_a, ref) {
    ...
    return (jsxRuntime.jsx("span", { className: "pixel-textLink ".concat(getType, " ").concat(isDisabled ? "pixel--textLink--disabled" : ""), children: jsxRuntime.jsx("a", __assign({ className: "pixel-textLink__label" }, (url ? { href: url } : {}), { onClick: url
                ? function () {
                }
                : props.onClick, target: url && target, children: jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [iconAlign === "Left" && icon, label, iconAlign === "Right" && icon] }) })) }));
});

var Alert = function (_a) {
    var _b = _a.title, title = _b === void 0 ? "Alert title here" : _b, _c = _a.description, description = _c === void 0 ? "Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups." : _c, _d = _a.color, color = _d === void 0 ? "Positive" : _d, _e = _a.emphasis, emphasis = _e === void 0 ? "Subtile" : _e, onDismiss = _a.onDismiss, _f = _a.icon, icon = _f === void 0 ? jsxRuntime.jsx(AlertCircle$1, { size: 20 }) : _f, secondaryAction = _a.secondaryAction, primaryAction = _a.primaryAction; __rest(_a, ["title", "description", "color", "emphasis", "onDismiss", "icon", "secondaryAction", "primaryAction"]);
    var checkColor = function () {
        switch (color) {
            case "Positive":
    ...
    return (jsxRuntime.jsxs("div", { className: "jiffyui-alert ".concat(AlertColor, " ").concat(AlertEmphasis, " ").concat(onDismiss ? "hasDismiss" : ""), children: [onDismiss && jsxRuntime.jsxs("div", { className: "jiffyui-alert-dismiss", children: [" ", jsxRuntime.jsx(Button, { variant: "Tertiary", icon: jsxRuntime.jsx(X$1, { size: 16 }), children: "", onClick: function () { return onDismiss === null || onDismiss === void 0 ? void 0 : onDismiss(); } })] }), jsxRuntime.jsxs("div", { className: "jiffyui-alert_inner", children: [icon && (jsxRuntime.jsx("div", { className: "jiffyui-alert_icon", children: icon })), jsxRuntime.jsxs("div", { className: "jiffyui-alert_content", children: [title &&
                                jsxRuntime.jsx("h3", { className: "jiffyui-alert_tile", children: title }), description &&
                                jsxRuntime.jsx("p", { className: "jiffyui-alert_description", children: description }), primaryAction || secondaryAction ? (jsxRuntime.jsxs("div", { className: "jiffyui-alert_actions", children: [primaryAction1(), secondaryAction1()] })) : null] })] })] }));
    function primaryAction1() {
        if (primaryAction) {
            var primaryAction1_1 = primaryAction;
            return (jsxRuntime.jsx(Button, __assign({ size: primaryAction1_1.size ? primaryAction1_1.size : "Medium", children: primaryAction1_1.children ? primaryAction1_1.children : "Submit" }, primaryAction1_1, { variant: primaryAction1_1.variant ? primaryAction1_1.variant : "Secondry" })));
        }
    }
    function secondaryAction1() {
        if (secondaryAction) {
            var secondaryAction1_1 = secondaryAction;
            return (jsxRuntime.jsx(TextLink, __assign({ label: secondaryAction1_1.label ? secondaryAction1_1.label : "Medium", icon: secondaryAction1_1.icon ? secondaryAction1_1.icon : jsxRuntime.jsx(ExternalLink$1, { size: 16 }) }, secondaryAction1_1)));
        }
    }
};
...
var AppWrapper = function (_a) {
    ...
    return (jsxRuntime.jsxs("main", { className: 'jiffyui-app_wrapper', children: [jsxRuntime.jsx("div", { className: "jiffyui-announcement_wrapper", children: announcementBar }), jsxRuntime.jsx("div", { className: "jiffyui-sidebar__Wrapper", children: sideBar }), jsxRuntime.jsxs("div", { className: "jiffyui-main__content", children: [jsxRuntime.jsx("div", { className: "jiffyui-topbar__wrapper", children: topBar }), jsxRuntime.jsx("div", { className: "jiffyui-content_wrapper", children: content }), jsxRuntime.jsx("div", { className: "jiffyui-footer__wrapper", children: footer })] })] }));
};
...
var Topbar = function (props) {
    ...
    var _e = React.useState(false), isOpenMobileSidebar = _e[0], OpenMobileSideBar = _e[1];
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs("header", { className: "Pixel-appBar--container ".concat(scrolled ? "header-sticky" : ""), children: [jsxRuntime.jsxs("div", { className: "appBar__connectLeft", children: [jsxRuntime.jsx("div", { className: "jiffyui-mobile_toggle", onClick: manageMobileSidebar, children: jsxRuntime.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", className: "h-6 w-6", children: jsxRuntime.jsx("path", { "stroke-linecap": "round", "stroke-linejoin": "round", d: "M3.75 6.75h16.5M3.75 12H12m-8.25 5.25h16.5" }) }) }), mobileLogo && jsxRuntime.jsx("a", { className: "jiffyui-mobile_logo", href: "", children: jsxRuntime.jsx("img", { src: mobileLogo }) }), connectLeft] }), connectRight && (jsxRuntime.jsx("div", { className: "Pixel-appBar__connectRight", children: connectRight }))] }), isOpenMobileSidebar && jsxRuntime.jsx(Portal, { children: jsxRuntime.jsx("div", { className: "jiffyui-sidebar_overlay", onClick: manageMobileSidebar, children: " " }) })] }));
};
...
var Avatar = function (_a) {
    var _b = _a.size, size = _b === void 0 ? "Medium" : _b, _c = _a.shape, shape = _c === void 0 ? "Squire" : _c, _d = _a.label, label = _d === void 0 ? "Label" : _d, _e = _a.icon, icon = _e === void 0 ? jsxRuntime.jsx(User$1, {}) : _e, _f = _a.srcIco, srcIco = _f === void 0 ? "" : _f, _g = _a.indicator, indicator = _g === void 0 ? "" : _g, onClick = _a.onClick; __rest(_a, ["size", "shape", "label", "icon", "srcIco", "indicator", "onClick"]);
    var checkSize = function () {
        switch (size) {
            case "Small":
    ...
    return (jsxRuntime.jsxs("div", { onClick: onClick, className: "jiffyui-avatar ".concat(avatarSize, " ").concat(avatarShape, " ").concat(srcIco ? "jiffyui-has-image-icon" : "", " ").concat(onClick ? "jiffyui-has-action" : "", " ").concat(indicator ? "jiffyui-has-indicator" : ""), children: [indicator ? jsxRuntime.jsx("div", { className: "jiffyui-avatar-indicator", children: indicator }) : null, jsxRuntime.jsx("div", { className: "jiffyui-avatar-icon", "data-labe": label, children: srcIco ? (jsxRuntime.jsx("img", { src: "".concat(srcIco), alt: label ? label : "Avatar" })) : icon })] }));
};
...
var Badge = function (_a) {
    ...
    return (jsxRuntime.jsx("div", { className: "badge-wrapp", children: jsxRuntime.jsxs("div", { className: "badge ".concat(BadgeSize, " ").concat(BadgeColor, " ").concat(BadgeType, " ").concat(BadgeEmphasis), children: [type === "Partial" ? jsxRuntime.jsx("span", { className: "partial" }) : null, type === "Full" ? jsxRuntime.jsx("span", { className: "complete" }) : null, jsxRuntime.jsx("label", { className: "badge-label", children: children })] }) }));
};
...
function BottomSheet(props) {
    ...
    return open || isOpen ? (jsxRuntime.jsx(Portal, { children: jsxRuntime.jsxs("div", { className: "bottom-sheet__wrapper", children: [jsxRuntime.jsx("div", { className: "bottom-sheet-overlay  ".concat(isOpen && open ? "open" : "close"), onClick: onDismiss, role: "none" }), jsxRuntime.jsx("div", { className: "bottom-sheet ".concat(isOpen && open ? "open" : "close"), children: jsxRuntime.jsxs("div", { className: "bottom-sheet-content", children: [jsxRuntime.jsxs("div", { className: heading ? "bottom-sheet__heading" : "bottom-sheet-header", children: [heading && jsxRuntime.jsx("h3", { className: "text-size-16 font-weight-600 line-height-24", children: heading }), jsxRuntime.jsx("button", { className: "close-button", onClick: onDismiss, children: jsxRuntime.jsx(X$1, { size: 20 }) })] }), jsxRuntime.jsx("div", { className: "bottom-sheet-body", children: children })] }) })] }) })) : null;
}
...
var Breadcrumb = function (props) {
    ...
    return (jsxRuntime.jsx("nav", { className: classnames({
            "Pixel-breadCrumb": true,
        }), "aria-label": "breadCrumb", children: jsxRuntime.jsx("ul", { className: "Pixel-breadCrumb__list", children: items.map(function (e, i) {
                return (jsxRuntime.jsx(React.Fragment, { children: i !== 0 ? (jsxRuntime.jsxs("li", { className: classnames({
                            "Pixel-breadCrumb__item": true,
                            "Pixel-breadCrumb__item--active": i === Object.keys(items).length - 1,
                        }), children: [jsxRuntime.jsx("span", { className: "Pixel-breadcrumb__separator mr-4", children: "/" }), i === Object.keys(items).length - 1 ? (jsxRuntime.jsx("span", { className: "Pixel-item__text--active", children: e.label })) : (jsxRuntime.jsx("span", { role: "none", onClick: function () {
                                    onClick === null || onClick === void 0 ? void 0 : onClick(e.value, e);
                                }, className: "Pixel-item__text", children: e.label }))] })) : (jsxRuntime.jsx("li", { className: "Pixel-breadCrumb__item", children: jsxRuntime.jsx("span", { role: "none", onClick: function () {
                                onClick === null || onClick === void 0 ? void 0 : onClick(e.value, e);
...
var ButtonGroup = function (_a) {
    ...
    return (jsxRuntime.jsx("div", { className: "buttonGroup ".concat(segmented ? "btn-segmented" : null), children: children }));
};
...
var Card = function (_a) {
    ...
    return (jsxRuntime.jsx("div", { className: "jiffy-card ".concat(cardTypeCss), children: jsxRuntime.jsxs("div", { className: "jiffy-card--inner", children: [headerTitle && (jsxRuntime.jsx(jsxRuntime.Fragment, { children: (jsxRuntime.jsxs("div", { className: "jiffy-card--title jiffy-card--title__header_action", children: [jsxRuntime.jsxs("div", { className: "jiffy-card--title_inner", children: [jsxRuntime.jsx("h3", { className: "jiffy-cord--title__text", children: headerTitle }), headerSubTitle && (jsxRuntime.jsx("p", { className: "card--subTitle", children: headerSubTitle }))] }), headerActions1()] }))  })), jsxRuntime.jsx("div", { className: "jiffy-card-body", children: jsxRuntime.jsx("div", { className: "jiffy-card--body__inner", children: children }) }), footerTitle && (jsxRuntime.jsxs("div", { className: "jiffy-card-footer jiffy-title-only", children: [jsxRuntime.jsx("h4", { className: "jiffy-card--footer_title__text", children: footerTitle }), jsxRuntime.jsx("p", { className: "jiffy-card--footer_description__text", children: footerSubtitle })] })), primaryAction || secondaryAction ? (jsxRuntime.jsx("div", { className: "jiffy-card-footer actions--only", children: jsxRuntime.jsxs("div", { className: "jiffy-card-footer__actions_wrapper", children: [secondaryAction1(), primaryAction1()] }) })) : null, (primaryAction || secondaryAction) && footerTitle ? (jsxRuntime.jsxs("div", { className: "jiffy-card-footer title-action", children: [jsxRuntime.jsxs("div", { className: "jiffy-card-footer__title_wrapper", children: [jsxRuntime.jsx("h4", { className: "jiffy-card--footer_title__text", children: footerTitle }), footerSubtitle && (jsxRuntime.jsx("p", { className: "jiffy-card--footer_description__text", children: footerSubtitle }))] }), jsxRuntime.jsxs("div", { className: "jiffy-card-footer__actions_wrapper", children: [primaryAction1(), secondaryAction1()] })] })) : null] }) }));
    function primaryAction1() {
        if (primaryAction) {
            ...
            return (jsxRuntime.jsx(Button, __assign({ size: "Medium", variant: "Primary", color: color ? color : "Primary", icon: icon && icon, alignIcon: alignIcon && alignIcon, isDisabled: isDisabled && isDisabled, isLoading: isLoading && isLoading, children: children_1 ? children_1 : "Git it!" }, primaryAction1, { onClick: onClick })));
        }
    }
    function secondaryAction1() {
        if (secondaryAction) {
            ...
            return (jsxRuntime.jsx(Button, __assign({ size: "Medium", variant: "Secondry", color: color ? color : "Primary", icon: icon && icon, alignIcon: alignIcon && alignIcon, isDisabled: isDisabled && isDisabled, isLoading: isLoading && isLoading, children: children_2 ? children_2 : "Git it!" }, secondaryAction1, { onClick: onClick })));
        }
    }
    function headerActions1() {
        if (headerActions) {
            return (jsxRuntime.jsx(Actionlist, { onClose: function () { return setActive(false); }, activator: jsxRuntime.jsx(Button, { variant: "Link", onClick: function () { return setActive(!active); }, children: "", icon: jsxRuntime.jsx(MoreHorizontal$1, { size: 18 }) }), open: active, options: headerActions }));
        }
    }
};
...
var TextStyle = function (_a) {
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: as === "dt" ? (jsxRuntime.jsx("dt", { className: "pixel-Text--root ".concat(decoration, " ").concat(style, " ").concat(color, " ").concat(textAlignment, " ").concat(textType, " ").concat(waight), children: children })) : as === "dd" ? (jsxRuntime.jsx("dd", { className: "pixel-Text--root ".concat(decoration, " ").concat(style, " ").concat(color, " ").concat(textAlignment, " ").concat(textType, " ").concat(waight), children: children })) : as === "h1" ? (jsxRuntime.jsx("h1", { className: "pixel-Text--root ".concat(decoration, " ").concat(style, " ").concat(color, " ").concat(textAlignment, " ").concat(textType, " ").concat(waight), children: children })) : as === "h2" ? (jsxRuntime.jsx("h2", { className: "pixel-Text--root ".concat(decoration, " ").concat(style, " ").concat(color, " ").concat(textAlignment, " ").concat(textType, " ").concat(waight), children: children })) : as === "h3" ? (jsxRuntime.jsx("h3", { className: "pixel-Text--root ".concat(decoration, " ").concat(style, " ").concat(color, " ").concat(textAlignment, " ").concat(textType, " ").concat(waight), children: children })) : as === "h4" ? (jsxRuntime.jsx("h4", { className: "pixel-Text--root ".concat(decoration, " ").concat(style, " ").concat(color, " ").concat(textAlignment, " ").concat(textType, " ").concat(waight), children: children })) : as === "h5" ? (jsxRuntime.jsx("h5", { className: "pixel-Text--root ".concat(decoration, " ").concat(style, " ").concat(color, " ").concat(textAlignment, " ").concat(textType, " ").concat(waight), children: children })) : as === "h6" ? (jsxRuntime.jsx("h6", { className: "pixel-Text--root ".concat(decoration, " ").concat(style, " ").concat(color, " ").concat(textAlignment, " ").concat(textType, " ").concat(waight), children: children })) : as === "p" ? (jsxRuntime.jsx("p", { className: "pixel-Text--root ".concat(decoration, " ").concat(style, " ").concat(color, " ").concat(textAlignment, " ").concat(textType, " ").concat(waight), children: children })) : as === "span" ? (jsxRuntime.jsx("span", { className: "pixel-Text--root ".concat(decoration, " ").concat(style, " ").concat(decoration, " ").concat(style, " ").concat(color, " ").concat(textAlignment, " ").concat(textType, " ").concat(waight), children: children })) : as === "strong" ? (jsxRuntime.jsx("strong", { className: "pixel-Text--root ".concat(decoration, " ").concat(style, " ").concat(color, " ").concat(textAlignment, " ").concat(textType, " ").concat(waight), children: children })) : as === "legend" ? (jsxRuntime.jsx("legend", { className: "pixel-Text--root ".concat(decoration, " ").concat(style, " ").concat(color, " ").concat(textAlignment, " ").concat(textType, " ").concat(waight), children: children })) : (jsxRuntime.jsx("span", { className: "pixel-Text--root ".concat(decoration, " ").concat(style, " ").concat(color, " ").concat(textAlignment, " ").concat(textType, " ").concat(waight), children: children })) }));
};
...
var CopyClipboard = function (_a) {
    ...
    var _h = React.useState(false), active = _h[0], setactive = _h[1];
    function copyText() {
        !status
    ...
    return (jsxRuntime.jsxs("div", { className: "copy-to__clipboard", onClick: onClick, children: [label && iconAlign === "right" && jsxRuntime.jsx(TextStyle, { as: "p", children: label }), jsxRuntime.jsx(Button, { children: "", variant: "Secondry", icon: active ? jsxRuntime.jsx(Check$1, { color: "#00A251", size: 20 }) : jsxRuntime.jsx(Copy$1, { size: 20 }), onClick: function () {
                    copyText();
                    setstatus(!status);
                    !status && setactive(!active);
                    setTimeout(function () { return setactive(false); }, timeout);
                } }), label && iconAlign === "left" && jsxRuntime.jsx(TextStyle, { as: "p", children: label })] }));
};
...
var Divider = function (_a) {
    ...
    return (jsxRuntime.jsx("div", { className: "jiffyui-divider ".concat(dividertThikness, " ").concat(DividerColor, " ").concat(dividerStyle, " ").concat(dividerOrientation) }));
};
...
function useWindowResize(debounceDelay) {
    ...
    var _a = React.useState(window.innerWidth), windowWidth = _a[0], setWindowWidth = _a[1];
    var updateWindowWidth = React.useCallback(function () {
        setWindowWidth(window.innerWidth);
    }, []);
    var debouncedUpdateWindowWidth = React.useCallback(function () {
        var timeoutId;
        return function () {
...
var Grid = function (props) {
    ...
    return (jsxRuntime.jsx("div", { className: getClassNames$1((_a = {
                "inte-grid": true
            },
...
var Item$2 = function (props) {
    return jsxRuntime.jsx(React.Fragment, { children: props.children });
};
Grid.Item = Item$2;
...
var HorizontalFlex = function (props) {
    ...
    var newChildrens = childrens.map(function (children, index) {
        ...
        if (children.props && ((_a = children.props) === null || _a === void 0 ? void 0 : _a.__TYPE) === "FlexItem") {
            ...
            return jsxRuntime.jsx(FlexItem, { children: children }, index);
        }
    });
    ...
    return (jsxRuntime.jsx("div", { className: classnames((_a = {
                'flex-row': true
            },
            _a["gap-" + gap] = gap,
            _a["flex-wrap"] = wrap,
...
var Indicator = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", { className: "jiffyui-indicator ".concat(IndicatorColor, " ").concat(IndicatorSize, " ").concat(content ? "has-string" : ""), children: [jsxRuntime.jsx("span", { className: "jiffyui-indicator-dot", children: content }), label && (jsxRuntime.jsx("label", { className: "jiffyui-indicator-label", children: label }))] }));
};
...
var Checkbox = function (props) {
    ...
    return (jsxRuntime.jsx("div", { className: classnames({
            ...
            "jiffyui-checkbox--hasError": hasError,
        }), children: jsxRuntime.jsxs("label", { htmlFor: "jiffyui-checkbox-".concat(rId), children: [jsxRuntime.jsx("input", { disabled: isDisabled, "aria-label": "jiffyui-checkbox-".concat(rId), "aria-checked": checked === "indeterminate" ? "mixed" : checked, id: "jiffyui-checkbox-".concat(rId), type: "checkbox", name: name, ref: function (ele) {
                        if (!ele)
                            return;
                        if (checked === "indeterminate")
                    ...
                    }) }), jsxRuntime.jsxs("span", { className: "jiffyui-checkboxWrap", children: [jsxRuntime.jsx("span", { className: "Pixel__checkboxEle--fake" }), label && (jsxRuntime.jsx("span", { className: "jiffyui-checkbox__label ".concat(required ? "jiffyui--required" : "").trim(), children: label }))] })] }) }));
};
...
var CheckboxGroup = function (props) {
    ...
    var _c = React.useState([]), grpVal = _c[0], setGrpVal = _c[1];
    ...
    return (jsxRuntime.jsxs("div", { className: classnames((_a = {
                "jiffyui-formGroup": true
            },
            _a[controlStatesVal] = controlStatesVal,
            _a)), children: [title && (jsxRuntime.jsx("h2", { className: "input-group-label", children: title })), jsxRuntime.jsx("ul", { className: "jiffyui-Group__list jiffyui-Group__list--".concat(direction), children: options.map(function (item, index) {
                    return (jsxRuntime.jsx("li", { className: classnames({
                            "jiffyui-Group__listItem": true,
                            "jiffyui-Group__listitem--clickable": isClickableFullItem,
                        }), children: jsxRuntime.jsx(Checkbox, { isDisabled: item.isDisabled, label: item.label, value: item.value, checked: value.includes(item.value), onChange: handleCheckboxGroupChange, name: name }) }, index));
                }) }), props.helpText && (jsxRuntime.jsxs("span", { className: classnames({
                    "jiffyui-formElement__itemHelp": true,
                    "jiffyui-formElement__itemHelp--hasHelpIcon": helpIcon,
                }), children: [helpIcon && jsxRuntime.jsx("span", { style: { display: "flex" }, children: helpIcon }), jsxRuntime.jsx("span", { children: props.helpText })] }))] }));
};

var Fileprogress = function () {
    return (jsxRuntime.jsx("div", { "aria-label": "Checking", children: jsxRuntime.jsx("div", { className: "jiffyui-file--progress", children: jsxRuntime.jsx("div", { className: "jiffyui-file--progressContainer", children: jsxRuntime.jsx("div", { className: "jiffyui-file--progressLoadingItem" }) }) }) }));
};

var CheckIcon = function () {
    return (jsxRuntime.jsxs("svg", { "aria-hidden": "true", height: "16px", viewBox: "0 0 24 24", width: "16px", fill: "none", children: [jsxRuntime.jsxs("g", { clipPath: "url(#clip0_60_208)", children: [jsxRuntime.jsx("path", { d: "M4.15845 7.14679C6.74812 4.11688 11.0222 3.1512 14.663 4.77343C15.1675 4.99821 15.7586 4.77147 15.9834 4.267C16.2082 3.76253 15.9815 3.17135 15.477 2.94657C11.0272 0.96385 5.80325 2.14413 2.6381 5.84735C-0.527049 9.55057 -0.879431 14.8946 1.77205 18.9813C4.42353 23.0681 9.44725 24.9241 14.1189 23.5429C18.7905 22.1616 21.9972 17.8716 22 13V12.07C22 11.5177 21.5523 11.07 21 11.07C20.4477 11.07 20 11.5177 20 12.07V12.9994C19.9977 16.9852 17.3741 20.4948 13.5518 21.6249C9.72957 22.7551 5.61926 21.2365 3.44986 17.8928C1.28047 14.5491 1.56878 10.1767 4.15845 7.14679Z", fill: 'var(--jiffyui-Possitive-700)' }), jsxRuntime.jsx("path", { d: "M22.7071 4.70711C23.0976 4.31658 23.0976 3.68342 22.7071 3.29289C22.3166 2.90237 21.6834 2.90237 21.2929 3.29289L11 13.5858L8.70711 11.2929C8.31658 10.9024 7.68342 10.9024 7.29289 11.2929C6.90237 11.6834 6.90237 12.3166 7.29289 12.7071L10.2929 15.7071C10.6834 16.0976 11.3166 16.0976 11.7071 15.7071L22.7071 4.70711Z", fill: "var(--jiffyui-Possitive-700)" })] }), jsxRuntime.jsx("defs", { children: jsxRuntime.jsx("clipPath", { id: "clip0_60_208", children: jsxRuntime.jsx("rect", { height: "24", width: "24", fill: "white" }) }) })] }));
};
var FileType = function () {
    return (jsxRuntime.jsxs("svg", { "aria-hidden": "true", height: 39, viewBox: "0 0 38 39", width: 38, fill: "none", children: [jsxRuntime.jsx("path", { d: "M5.5 31.5801H3L5.5 34.0801V31.5801Z", fill: "var(--jiffyui-Cerulean-600)" }), jsxRuntime.jsx("path", { d: "M32.7998 31.5801H35.2998L32.7998 34.0801V31.5801Z", fill: "var(--jiffyui-Cerulean-600)" }), jsxRuntime.jsx("path", { d: "M6.35552 2.71162C6.91384 2.09227 7.66518 1.75 8.44238 1.75H25.9153L32.832 9.42294V33.5872C32.832 34.4743 32.514 35.3206 31.955 35.9408C31.3966 36.5601 30.6453 36.9024 29.8681 36.9024H8.44238C7.66518 36.9024 6.91384 36.5601 6.35552 35.9408C5.79644 35.3206 5.47852 34.4743 5.47852 33.5872V5.06524C5.47852 4.17809 5.79644 3.33184 6.35552 2.71162Z", clipRule: "evenodd", fill: "hsla(201, 92%, 95%, 1)", fillRule: "evenodd", stroke: "var(--jiffyui-Cerulean-600)" }), jsxRuntime.jsx("path", { d: "M3 19.3262H35.31V31.5817H3V19.3262Z", fill: "var(--jiffyui-Cerulean-600)", strokeWidth: "0.5" })] }));
};
...
var FileItem = function (_a) {
    ...
    var _b = React.useState(false), isError = _b[0], setIsError = _b[1];
    var _c = React.useState(""), status = _c[0], setStatus = _c[1];
    ...
    return (jsxRuntime.jsxs("div", { className: "jiffyui-fileItem", children: [jsxRuntime.jsx("div", { className: classnames({
                    "jiffyui-item__wrapper": true,
                    "jiffyui-item--error": isError,
                }), children: jsxRuntime.jsx("div", { className: "jiffyui-item", children: jsxRuntime.jsxs("div", { className: "jiffyui-item__container", children: [jsxRuntime.jsx("div", { className: "jiffyui-item__formatIcon", children: jsxRuntime.jsxs("div", { className: "jiffyui-item__format", children: [jsxRuntime.jsx(FileType, {}), jsxRuntime.jsxs("p", { className: "jiffyui-item__formatName", children: [".", fileExtension] })] }) }), jsxRuntime.jsxs("div", { className: "jiffyui-item__name", children: [jsxRuntime.jsxs("div", { className: "jiffyui-item__nameWrapper", children: [jsxRuntime.jsx("div", { className: "jiffyui-item__fileName", children: jsxRuntime.jsxs("p", { children: [" ", item.data.name] }) }), fileUpload && jsxRuntime.jsx(CheckIcon, {})] }), jsxRuntime.jsxs("p", { className: "jiffyui-item__size", children: [" ", formatBytes(item.data.size), " ", isError && jsxRuntime.jsxs("span", { children: ["- ", status] })] })] }), jsxRuntime.jsx("div", { className: "jiffyui-item__clear", children: jsxRuntime.jsx("button", { type: "button", "aria-label": "Remove File", className: "jiffyui-item__button", onClick: function () { return removeImage(item.id); }, children: jsxRuntime.jsx(Trash2$1, { height: 16, width: 16 }) }) })] }) }) }), !fileUpload && jsxRuntime.jsx(Fileprogress, {})] }));
};
...
var FileUpload = function (props) {
    ...
    var _b = React.useState([]), filesData = _b[0], setFilesData = _b[1];
    var _c = React.useState(false), isDragOver = _c[0], setIsDragOver = _c[1];
    var inputUploadRef = React.useRef(null);
    ...
    return (jsxRuntime.jsxs("div", { className: classnames({
            "jiffyui-fileUpload": true,
        }), children: [jsxRuntime.jsxs("label", { htmlFor: "jiffyui-fileUpload-".concat(rID), className: classnames({
                ...
                }), ref: inputWrapperRef, onDrop: function (e) { return handleDrop(e); }, onDragOver: function (e) { return handleDragOver(e); }, onDragLeave: function (e) { return handleDragLeave(e); }, "aria-disabled": isDisabled || filesData.length === maxCount ? "true" : "false", children: [jsxRuntime.jsx("input", { type: "file", ref: inputUploadRef, id: "jiffyui-fileUpload-".concat(rID), className: "jiffyui-fileUpload__inputBox", onChange: function (e) { return handleInputChange(e); }, multiple: isMultiple, disabled: isDisabled || filesData.length === maxCount, accept: "".concat(acceptValue) }), jsxRuntime.jsxs("div", { className: "jiffyui-fileUpload__uploadText", children: [jsxRuntime.jsx("span", { children: "Drag files here or" }), jsxRuntime.jsx("span", { children: "Upload" })] })] }), helpText && (jsxRuntime.jsxs("span", { className: classnames({
                    "jiffyui-fileUpload__itemHelp": true,
                    "jiffyui-fileUpload__itemHelp--HasHelpIcon": helpIcon,
                }), children: [helpIcon !== null && helpIcon !== void 0 ? helpIcon : null, jsxRuntime.jsx("span", { children: helpText })] })), filesData.length !== 0 && (jsxRuntime.jsx(jsxRuntime.Fragment, { children: filesData.map(function (i, ind) {
                    return (jsxRuntime.jsx(FileItem$1, { removeImage: removeImage, accept: accept, item: i, sizeAllowed: maxSize, fileUpload: isFileUploaded[ind] }, i.id));
                }) }))] }));
};
...
var Radio = function (props) {
    ...
    var rId = React.useId();
    return (jsxRuntime.jsx("div", { className: "jiffyui-radio", children: jsxRuntime.jsx("label", { htmlFor: id || "jiffyui-radio-".concat(rId), className: "jiffyui-radio__label ".concat(isDisabled ? "disbaled" : null), children: jsxRuntime.jsx("div", { className: "jiffyui-radio jiffyui-radio__container", children: jsxRuntime.jsxs("div", { className: "jiffyui-radio jiffyui-radio__inputWrapper", children: [jsxRuntime.jsx("input", { type: "radio", id: id || "jiffyui-radio-".concat(rId), name: name, "aria-disabled": "false", "aria-checked": "true", "aria-describedby": "radio-245-helptext-246", className: classnames({
                                "jiffyui-radio__input": true,
                                "jiffyui-radio__input--error": hasError,
                            }), value: value, 
                            // onChange={() => onChange?.(value)}
                            onChange: isDisabled ? function () { } : function () { return onChange === null || onChange === void 0 ? void 0 : onChange(value); }, checked: checked, disabled: isDisabled }), jsxRuntime.jsx("div", { className: classnames({
                                "jiffyui-radio__iconWrapper": true,
                                "jiffyui-radio__checked": checked,
                            }), children: jsxRuntime.jsx("div", { className: "jiffyui-radio__iconContainer", style: { position: "absolute", display: "flex" }, children: jsxRuntime.jsx("svg", { "aria-hidden": "true", height: "20px", viewBox: "0 0 16 16", width: "20px", fill: "none", children: jsxRuntime.jsx("circle", { cx: "8", cy: "8", r: "3", fill: "hsla(0, 0%, 100%, 1)" }) }) }) }), jsxRuntime.jsx("div", { className: "jiffyui-radio jiffyui-radio__gap" }), jsxRuntime.jsx("span", { className: "jiffyui-radio__text", children: label })] }) }) }) }));
};
...
var RadioGroup = function (props) {
    ...
    return (jsxRuntime.jsxs("div", { className: classnames((_a = {
            ...
            _a[controlStatesVal] = controlStatesVal,
            _a)), children: [title && (jsxRuntime.jsx("h2", { className: "input-group-label", children: title })), jsxRuntime.jsx("ul", { className: "jiffyui-formGroup__list jiffyui-formGroup__list--".concat(direction), children: options.map(function (item, index) {
                    return (jsxRuntime.jsx("li", { className: classnames({
                            "jiffyui-formGroup__listItem": true,
                            "jiffyui-formGroup__listitem--clickable": isClickableFullItem,
                        }), children: jsxRuntime.jsx(Radio, { isDisabled: item.isDisabled, label: item.label, value: item.value, checked: value === item.value, onChange: onChange, name: name || "radioGroup" + rName }) }, index));
                }) }), props.helpText && (jsxRuntime.jsxs("span", { className: classnames({
...
var Tag = function (_a) {
    ...
    return (jsxRuntime.jsx("div", { className: "tag-wrapp", children: jsxRuntime.jsxs("div", { className: "tag ".concat(TageSize, " ").concat(onDismis ? "hasDismis" : ""), children: [jsxRuntime.jsx("span", { className: "tag-label", children: children }), onDismis &&
                    jsxRuntime.jsx("span", { className: "tag-clear", onClick: function (e) { return onDismis(e); }, role: "none", children: jsxRuntime.jsx(X$1, { size: 16 }) })] }) }));
};
...
var Select = function (props) {
    ...
    var _e = React.useState(options), optionsToShow = _e[0], setOptionsToShow = _e[1];
    var selectRef = React.useRef(null);
    var inputBoxRef = React.useRef(null);
    var _f = React.useState(false), isOpen = _f[0], setIsOpen = _f[1];
    var _g = React.useState(), selectedValue = _g[0], setSelectedValue = _g[1];
    var _h = React.useState(""), inputText = _h[0], setInputText = _h[1];
    React.useEffect(function () {
        var _a;
        var val = value;
    ...
    return (jsxRuntime.jsxs("div", { className: "pixel-sc", children: [label ? (jsxRuntime.jsx("label", { className: "jiffyui-form__label", children: label })) : null, jsxRuntime.jsxs("div", { className: "pixel-sc__container", ref: selectRef, children: [jsxRuntime.jsxs("div", { className: "pixel-sc__activator c-pointer", onClick: function () {
                            var _a;
                            setIsOpen(!isOpen);
                            type === "autoComplete" && ((_a = inputBoxRef === null || inputBoxRef === void 0 ? void 0 : inputBoxRef.current) === null || _a === void 0 ? void 0 : _a.focus());
                        }, role: "none", children: [Array.isArray(value) && value.length > 0 ? (jsxRuntime.jsx("div", { className: "pixel-sc__tags flex gap-8 align-center", children: selectedValue.map(function (tag, ind) {
                                    return (jsxRuntime.jsx(Tag, { onDismis: function (e) {
                                            e.stopPropagation();
                                            onChange(value, tag.value);
                                        }, children: tag.label }, ind));
                                }) })) : (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [type === "select" && (jsxRuntime.jsx("button", { children: (selectedValue === null || selectedValue === void 0 ? void 0 : selectedValue.length) === 0
                                            ? placeholder || "Select"
                                            : (_a = selectedValue === null || selectedValue === void 0 ? void 0 : selectedValue[0]) === null || _a === void 0 ? void 0 : _a.label })), type === "autoComplete" && selectionType === "single" && (jsxRuntime.jsx("input", { placeholder: placeholder || "Search", ref: inputBoxRef, className: "pixel-autocomplete w-full border-none outline-none bg-transparent font-size-14", value: inputText, onChange: function (e) {
                                            !isOpen && setIsOpen(true);
                                            setInputText(e.target.value);
                                            handleFilteroptions(e.target.value);
                                        } }))] })), type === "autoComplete" && selectionType === "multiple" && (jsxRuntime.jsx("input", { ref: inputBoxRef, placeholder: placeholder || "Search", className: "pixel-autocomplete w-full border-none outline-none bg-transparent font-size-14", value: inputText, onChange: function (e) {
                                    resizeInputBox(e);
                                    setInputText(e.target.value);
                                    handleFilteroptions(e.target.value);
                                }, style: { minWidth: "0.1rem" } }))] }), jsxRuntime.jsx("div", { className: "pixel-sc__icon", children: jsxRuntime.jsx("span", { className: "flex", children: jsxRuntime.jsx(ChevronDown$1, { height: 16, width: 16 }) }) })] }), jsxRuntime.jsx(Dropdown, { open: isOpen, ref: selectRef, isWidthEqual: true, resizeDependency: selectedValue, padding: 8, onOutsideClick: handleOutsideClick, children: jsxRuntime.jsxs("ul", { className: "pixel-ac__container", children: [(type === "select" ? options : optionsToShow).map(function (item, index) {
                            return (jsxRuntime.jsxs("li", { role: "none", className: classnames({
                                    "pixel-ac__item": true,
                                ...
                                }, children: [selectionType === "multiple" && !item.group && (jsxRuntime.jsx("span", { className: "".concat(Array.isArray(value) && value.indexOf(item.value) !== -1
                                            ? "v-visible"
                                            : "v-hidden"), children: jsxRuntime.jsx(Check$1, { size: 16, stroke: "rgb(12, 50, 189)" }) })), jsxRuntime.jsx("div", { children: item.label }), item.group && (jsxRuntime.jsx("ul", { children: item.group.map(function (child, childIndex) {
                                            return (jsxRuntime.jsxs("li", { role: "none", className: classnames({
                                                    "pixel-ac__item": true,
                                                ...
                                                }, children: [selectionType === "multiple" && (jsxRuntime.jsx("span", { className: "".concat(Array.isArray(value) &&
                                                            value.indexOf(child.value) !== -1
                                                            ? "v-visible"
                                                            : "v-hidden"), children: jsxRuntime.jsx(Check$1, { size: 16, stroke: "rgb(12, 50, 189)" }) })), jsxRuntime.jsx("div", { children: child.label })] }, child + childIndex));
                                        }) }))] }, item + index));
                        }), optionsToShow.length === 0 && (jsxRuntime.jsx("li", { children: jsxRuntime.jsx("div", { className: "text-center", children: "No search result found" }) }))] }) }), jsxRuntime.jsx("div", { className: "jiffyui-formElement__itemHelp", children: helpText && jsxRuntime.jsx("span", { className: "pixel-ac__helpText", children: props.helpText }) })] }));
};
...
var TextArea = function (props) {
    ...
    return (jsxRuntime.jsxs("div", { className: classnames({
        ...
        }), children: [label ? (jsxRuntime.jsx("label", { htmlFor: "jiffyui-textArea-".concat(rId), id: "jiffyui-textArea__label-".concat(rId), className: classnames({
                    "jiffyui-form__label": true,
                    "jiffyui--required": required,
                }), children: label })) : null, jsxRuntime.jsx("textarea", __assign({ id: "jiffyui-textArea-".concat(rId), className: "jiffyui-formElement_textArea__control jiffyui-formElement__textArea", style: {
                    opacity: readOnly ? "0.6" : "1",
                    width: "100%",
                    resize: resize,
                }, rows: rows, value: value, readOnly: readOnly, onChange: function (e) {
                    onChange(e.target.value);
                }, placeholder: placeholder, "aria-labelledby": "jiffyui-textArea__label-".concat(rId) }, (required ? { "aria-required": "true" } : {}))), helpText ? (jsxRuntime.jsx("span", { className: "jiffyui-formElement__itemHelp", children: helpText })) : null] }));
};
...
var TextField = React.forwardRef(function (props, ref) {
    ...
    var innerPreref = React.useRef(null);
    var innerSufrefWidth = React.useRef(null);
    var _h = React.useState(0), paddingLeft = _h[0], setPaddingLeft = _h[1];
    var _j = React.useState(0), paddingRight = _j[0], setPaddingRight = _j[1];
    var getcontrolStates = {
        success: "jiffyui-formElement--success",
        warning: "jiffyui-formElement--warning",
        error: "jiffyui-formElement--error",
    ...
    var getInput = function () { return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("input", { ref: inputRef, style: {
    ...
    return (jsxRuntime.jsxs("div", { className: classnames((_a = {
            ...
            _a[sizeVal] = sizeVal,
            _a)), children: [label ? (jsxRuntime.jsx("label", { htmlFor: "jiffyui-textField-".concat(rId), id: "jiffyui-textField__label-".concat(rId), className: classnames({
                    "jiffyui-form__label": true,
                    "jiffyui--required": isRequired,
                }), children: label })) : null, jsxRuntime.jsxs("div", { className: "jiffyui-formElement__inner", ref: ref, children: [getInput(), prefix !== "" ? (jsxRuntime.jsx("span", { ref: innerPreref, className: "jiffyui-formElement__prefixIcon", children: prefix })) : null, suffix !== "" && props.type !== "number" ? (jsxRuntime.jsx("span", { ref: innerSufrefWidth, className: "jiffyui-formElement__suffixIcon", children: suffix })) : null] }), props.helpText && (jsxRuntime.jsxs("span", { id: "jiffyui-textFiled__description-".concat(rId), className: classnames({
                    "jiffyui-formElement__itemHelp": true,
                    "jiffyui-formElement__itemHelp--hasHelpIcon": helpIcon,
                }), children: [helpIcon && jsxRuntime.jsx("span", { className: "jiffyui-formElement__itemHelp--helpIcon", children: helpIcon }), jsxRuntime.jsx("span", { children: props.helpText })] }))] }));
});
...
var List = function (_a) {
    ...
    return (jsxRuntime.jsx("div", { className: "".concat(type === "ol" ? olListStyle + '__style' : "", " ").concat(type === "ul" ? ulListStyle + '__style' : ""), children: type === "ul" ? (jsxRuntime.jsx("ul", { className: "jiffyui-list ".concat(ulListStyle, " ").concat(listType), children: children.map(function (item, index) { return jsxRuntime.jsx(React.Fragment, { children: item }, index); }) })) : (jsxRuntime.jsx("ol", { className: "jiffyui-list ".concat(olListStyle, " ").concat(listType), children: children.map(function (item, index) { return jsxRuntime.jsx(React.Fragment, { children: item }, index); }) })) }));
};
var Item$1 = function (props) {
    var children = props.children;
    return (jsxRuntime.jsx("li", { className: "jiffyui-list--item", children: children }));
};
List.Item = Item$1;
...
var MediaCard = function (_a) {
    ...
    var _g = React.useState(false), active = _g[0], setActive = _g[1];
    return (jsxRuntime.jsx("div", { className: "jiffyui-mediaCard ".concat(cardTypeCss, " ").concat(orientation1), children: jsxRuntime.jsxs("div", { className: "jiffyui-mediaCard--inner", children: [jsxRuntime.jsx("div", { className: "jiffyui-mediaCard-thumbnail", children: jsxRuntime.jsx("div", { className: "jiffyui-mediaCard-image", children: jsxRuntime.jsx("img", { alt: "test", src: mediaSrc, style: { width: "100%" } }) }) }), title || subtitle ? (jsxRuntime.jsxs("div", { className: "jiffyui-mediaCard-body", children: [title && (jsxRuntime.jsx(jsxRuntime.Fragment, { children: headerActions ? (jsxRuntime.jsxs("div", { className: "jiffyui-mediaCard-title_wrapper jiffyui-mediaCard--title__action", children: [jsxRuntime.jsxs("div", { className: "jiffyui-mediaCard--title_inner", children: [jsxRuntime.jsx("h4", { className: "jiffyui-mediaCard-title__text", children: title }), subtitle && (jsxRuntime.jsx("p", { className: "jiffyui-mediaCard-description__text", children: subtitle }))] }), headerActions1()] })) : (jsxRuntime.jsxs("div", { className: "jiffyui-mediaCard-title_wrapper", children: [jsxRuntime.jsx("h4", { className: "jiffyui-mediaCard-title__text", children: title }), subtitle && (jsxRuntime.jsx("p", { className: "jiffyui-mediaCard-description__text", children: subtitle }))] })) })), jsxRuntime.jsxs("div", { className: "jiffyui-mediaCard-actions_wrapper", children: [secondaryAction1(), primaryAction1()] })] })) : null] }) }));
    function primaryAction1() {
        if (primaryAction) {
            ...
            return (jsxRuntime.jsx(Button, __assign({ size: "Medium", variant: "Primary", color: color ? color : "Primary", icon: icon && icon, alignIcon: alignIcon && alignIcon, isDisabled: isDisabled && isDisabled, isLoading: isLoading && isLoading, children: children ? children : "Primary action" }, primaryAction1, { onClick: onClick })));
        }
    }
    function secondaryAction1() {
        if (secondaryAction) {
            ...
            return (jsxRuntime.jsx(Button, __assign({ size: "Medium", variant: "Secondry", color: color ? color : "Primary", icon: icon && icon, alignIcon: alignIcon && alignIcon, isDisabled: isDisabled && isDisabled, isLoading: isLoading && isLoading, children: children ? children : "Secondary Action" }, secondaryAction1, { onClick: onClick })));
        }
    }
    function headerActions1() {
        if (headerActions) {
...
var Modal = function (_a) {
    ...
    var open = useDelay(isOpen, 600);
    return (open || isOpen) ? (jsxRuntime.jsxs(Portal, { children: [jsxRuntime.jsx("div", { className: "jiffyui-modal_overlay  ".concat((isOpen && open) ? "open" : "close"), onClick: onDismiss, role: "none" }), jsxRuntime.jsx("div", { className: "jiffyui-modal ".concat((isOpen && open) ? "open" : "close"), children: jsxRuntime.jsx("div", { className: "jiffyui-modal_inner", children: jsxRuntime.jsxs("div", { className: "jiffyui-modal-content", children: [jsxRuntime.jsxs("div", { className: "jiffyui-modal-header", children: [title && (jsxRuntime.jsx(TextStyle, { as: "h4", type: "MdHeading", textColor: "Dark", children: title })), jsxRuntime.jsx("button", { className: "jiffyui-close-button", onClick: onDismiss, children: jsxRuntime.jsx(X$1, { size: 20 }) })] }), jsxRuntime.jsx("div", { className: "jiffyui-modal-body", children: children }), footer &&
                                jsxRuntime.jsx("div", { className: "jiffyui-modal_footer", children: footer })] }) }) })] })) : null;
};
...
var PageTitle = React.forwardRef(function (_a, ref) {
    ...
    var _d = React.useState(false), isOpenMobileAction = _d[0], setOpenMobileActions = _d[1];
    ...
    return (jsxRuntime.jsxs("div", { className: "pageTitle ".concat(isReverseNavigation && "has-reverseNavigation"), children: [isMobile && isReverseNavigation && (jsxRuntime.jsxs("button", { onClick: onClick, className: "pageTitle-back__btn btn  btn--link btn--medium btn--primary__color btn-icon", children: [jsxRuntime.jsx("div", { className: "btn-icon", children: jsxRuntime.jsx(ChevronLeft$1, {}) }), jsxRuntime.jsx("span", { className: "btn-text", children: "Back" })] })), jsxRuntime.jsxs("div", { className: "rev-title__wrapper", children: [isReverseNavigation && (jsxRuntime.jsx("button", { className: "pageTitle-back__btn", onClick: onClick, children: jsxRuntime.jsx(ChevronLeft$1, {}) })), jsxRuntime.jsxs("div", { className: "pageTitle-wrapper", children: [title && (jsxRuntime.jsxs("div", { className: "".concat(badge && "title-with__badge", " "), children: [jsxRuntime.jsx("h1", { className: "pageTitle-title", children: title }), badge && badge1()] })), description && (jsxRuntime.jsx("p", { className: "pageTitle-description", children: description }))] })] }), primaryAction || secondaryAction || tertiaryAction ? (jsxRuntime.jsx("div", { className: "pageTitle-actions", children: isMobile ? (jsxRuntime.jsxs("div", { className: "pageTitle-actions_wrapper", children: [jsxRuntime.jsx("span", { ref: activatorRef, children: jsxRuntime.jsx(Button, { onClick: function () {
                                    setOpenMobileActions(!isOpenMobileAction);
                                }, variant: "Tertiary", children: "", icon: jsxRuntime.jsx(MoreHorizontal$1, { size: 20 }) }) }), PrimaryAction1(), jsxRuntime.jsxs("div", { ref: dropdownRef, className: "pageTitle-action_wrapper ".concat(isOpenMobileAction ? "mobile-actions_open" : ""), children: [tertiaryAction1(), secondaryAction1()] })] })) : (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [tertiaryAction1(), secondaryAction1(), PrimaryAction1()] })) })) : null] }));
    function PrimaryAction1() {
        if (primaryAction) {
            ...
            return (jsxRuntime.jsx(Button, __assign({ size: size !== null && size !== void 0 ? size : "Medium", children: children !== null && children !== void 0 ? children : "Submit", isDisabled: isDisabled ? true : false }, primaryAction, { variant: variant !== null && variant !== void 0 ? variant : "Primary" })));
        }
    }
    function secondaryAction1() {
        if (secondaryAction) {
            var secondaryAction1_1 = secondaryAction;
            return (jsxRuntime.jsx(Button, __assign({ size: secondaryAction1_1.size ? secondaryAction1_1.size : "Medium", children: secondaryAction1_1.children ? secondaryAction1_1.children : "Submit" }, secondaryAction1_1, { variant: secondaryAction1_1.variant ? secondaryAction1_1.variant : "Secondry" })));
        }
    }
    function tertiaryAction1() {
        if (tertiaryAction) {
            var tertiaryAction1_1 = tertiaryAction;
            return (jsxRuntime.jsx(Button, __assign({ size: tertiaryAction1_1.size ? tertiaryAction1_1.size : "Medium", children: tertiaryAction1_1.children ? tertiaryAction1_1.children : "Submit" }, secondaryAction1, { variant: tertiaryAction1_1.variant ? tertiaryAction1_1.variant : "Link" })));
        }
    }
    function badge1() {
        if (badge) {
            var size = badge.size, color = badge.color, type = badge.type, emphasis = badge.emphasis, children = badge.children;
            return (jsxRuntime.jsx(Badge, { color: color !== null && color !== void 0 ? color : "Positive", children: children !== null && children !== void 0 ? children : "Success", type: type !== null && type !== void 0 ? type : "None", size: size !== null && size !== void 0 ? size : "Medium", emphasis: emphasis !== null && emphasis !== void 0 ? emphasis : "Intense" }));
        }
    }
});
...
var Pagination = function (props) {
    ...
    return (jsxRuntime.jsxs("nav", { "aria-label": "Pagination", className: classnames({
            "Pixel-Pagination": true,
            "flex-row justify-between": type === "end",
        }), children: [primaryAction && (jsxRuntime.jsx("div", { className: "Pixel-Pagination__action", children: primaryAction })), jsxRuntime.jsxs("div", { className: classnames({
                    "flex-row align-center": true,
                    "Pixel-Pagination__center justify-center": type === "center",
                }), children: [jsxRuntime.jsx("div", { className: "Pixel-ButtonGroup__Item", children: jsxRuntime.jsx(Button, { children: "Previous", variant: "Tertiary", isDisabled: isPreviousDisable, onClick: function () { return onPrevious === null || onPrevious === void 0 ? void 0 : onPrevious(); } }) }), children && jsxRuntime.jsx("div", { className: "Pixel-Pagination__label", children: children }), jsxRuntime.jsx("div", { className: "Pixel-ButtonGroup__Item", children: jsxRuntime.jsx(Button, { children: "Next", variant: "Tertiary", isDisabled: isNextDisable, onClick: function () { return onNext === null || onNext === void 0 ? void 0 : onNext(); } }) })] })] }));
};
...
var ProgressBar = React.forwardRef(function (_a, ref) {
    ...
    return (jsxRuntime.jsxs("div", { ref: ref, className: "progress ".concat(progressVarent, " ").concat(progressSize), "progress-data": outOf, children: [jsxRuntime.jsx("div", { className: "progress-inner", style: { 'width': valuePercentage + '%' }, children: jsxRuntime.jsx("label", { className: "progress-label", children: label }) }), jsxRuntime.jsx("div", { className: "progress-val", children: valuePercentage + '%' })] }));
});
...
var SideBar = function (_a) {
    var _b;
    var onChange = _a.onChange, _c = _a.logo, logo = _c === void 0 ? jsxRuntime.jsx("img", { src: '', className: "sidebar-logo" }) : _c, children = _a.children, _d = _a.isCloseOnEsc, isCloseOnEsc = _d === void 0 ? true : _d, className = _a.className; _a.isLogoutAction;
    var context = React.useContext(AppContext);
    var _e = React.useState({}), expandedItem = _e[0], setExpandedItem = _e[1];
    var expandIconClickHandler = React.useCallback(function (e, path, flag) {
        var _a;
        e.stopPropagation();
    ...
    var footerHeight = React.useMemo(function () {
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("aside", { className: classnames((_b = {
                    "Pixel-sideBar": true
                },
                _b[className] = className,
                _b)), style: containerStyle, ref: sideBarRef, children: [jsxRuntime.jsx("div", { className: "sidebar-header", children: logo && jsxRuntime.jsx("div", { className: "Pixel-sideBar__logo", children: logo }) }), jsxRuntime.jsx("div", { className: "Pixel-sideBar__ItemList", children: Array.isArray(children)
                        ? children === null || children === void 0 ? void 0 : children.map(function (item, index) {
                            return (jsxRuntime.jsx(React.Fragment, { children: jsxRuntime.jsx(Item, __assign({}, item === null || item === void 0 ? void 0 : item.props, { onChange: handelRouteChange, expandedItem: expandedItem, expandIconClickHandler: expandIconClickHandler })) }, index));
                        })
                        : (children === null || children === void 0 ? void 0 : children.props.menu) && (jsxRuntime.jsx(Item, __assign({}, children === null || children === void 0 ? void 0 : children.props, { onChange: handelRouteChange, expandedItem: expandedItem, expandIconClickHandler: expandIconClickHandler }))) }), jsxRuntime.jsx("div", { className: "sidebar-footer", children: jsxRuntime.jsxs("div", { className: "Pixel-sideBar--logout__Item", children: [jsxRuntime.jsx("div", { className: "Pixel-sideBar__Icon", children: jsxRuntime.jsx(LogOut$1, { size: 16 }) }), jsxRuntime.jsx("div", { className: "Pixel-sideBar__label", children: "Logout" })] }) })] }) }));
};
var Item = function (_a) {
    ...
    var makeMenuList = function (item, parent) {
        ...
        return (jsxRuntime.jsx("li", { className: classnames({
            ...
            }), children: jsxRuntime.jsxs("div", { role: "none", className: "Pixel-sideBar__itemBody", onClick: function () { return onChange(parent + item.path); }, children: [jsxRuntime.jsxs("div", { className: "Pixel-sideBar__linkBody", children: [item.icon && (jsxRuntime.jsx("div", { className: "Pixel-sideBar__Icon", children: item.icon })), jsxRuntime.jsx("div", { className: "Pixel-sideBar__label", children: item.label })] }), item.badge && (jsxRuntime.jsx("div", { className: "Pixel-sideBar__badge", children: item.badge }))] }) }, item.id));
    };
    var MakeExpandableItem = function (parentItem) {
        ...
        return (jsxRuntime.jsxs("li", { className: classnames({
                "Pixel-sideBar__listItem": true,
            ...
            }), children: [jsxRuntime.jsxs("div", { role: "none", className: "Pixel-sideBar__itemBody", onClick: function (e) { return expandIconClickHandler(e, parentItem.path, active); }, children: [jsxRuntime.jsxs("div", { className: "Pixel-sideBar__linkBody", children: [parentItem.icon && (jsxRuntime.jsx("div", { className: "Pixel-sideBar__Icon", children: parentItem.icon })), jsxRuntime.jsx("div", { className: "Pixel-sideBar__label", children: parentItem.label })] }), jsxRuntime.jsx("div", { className: classnames({
                                "Pixel-sideBar__expandIcon": true,
                                "Pixel-sideBar__expandIcon--active": active,
                            }), children: jsxRuntime.jsx(ChevronDown$1, { size: "16", color: "rgb(64, 86, 109)" }) })] }), jsxRuntime.jsx("ul", { className: "Pixel-sideBar__childList", children: (_b = parentItem.children) === null || _b === void 0 ? void 0 : _b.map(function (item) {
    ...
    return (jsxRuntime.jsxs("div", { className: classnames({
        ...
        }), children: [title && jsxRuntime.jsx("div", { className: "Pixel-sideBar__title", children: title }), jsxRuntime.jsx("nav", { "aria-label": id, children: jsxRuntime.jsx("ul", { className: "Pixel-sideBar__list", children: menu.map(function (item) {
                        if (item.children)
...
var SideSheet = function (_a) {
    var isOpen = _a.isOpen, onDismiss = _a.onDismiss, children = _a.children, _b = _a.title, title = _b === void 0 ? "Lorem ipsum" : _b, footer = _a.footer; __rest(_a, ["isOpen", "onDismiss", "children", "title", "footer"]);
    var open = useDelay(isOpen, 600);
    return (open || isOpen) ? (jsxRuntime.jsxs(Portal, { children: [jsxRuntime.jsx("div", { className: "side-sheet_overlay  ".concat((isOpen && open) ? "open" : "close"), onClick: onDismiss, role: "none" }), jsxRuntime.jsx("div", { className: "side-sheet ".concat((isOpen && open) ? "open" : "close"), children: jsxRuntime.jsx("div", { className: "side-sheet_inner", children: jsxRuntime.jsxs("div", { className: "side-sheet-content", children: [jsxRuntime.jsxs("div", { className: "side-sheet-header", children: [title && (jsxRuntime.jsx(TextStyle, { as: "h4", type: "MdHeading", textColor: "Dark", children: title })), jsxRuntime.jsx("button", { className: "close-button", onClick: onDismiss, children: jsxRuntime.jsx(X$1, { size: 20 }) })] }), jsxRuntime.jsx("div", { className: "side-sheet-body", children: children }), footer &&
                                jsxRuntime.jsx("div", { className: "side-sheet_footer", children: footer })] }) }) })] })) : null;
};
...
var StepWizard = function (_a) {
    ...
    var _f = React.useState(false), isMobile = _f[0], setIsMobile = _f[1];
    currentStep =
    ...
    var forDesktop = (jsxRuntime.jsx("ul", { className: getClassNames((_b = {
                stepWizard: true
            },
            ...
            return (jsxRuntime.jsxs("li", { className: "stepWizard__step ".concat(t), style: {
                    flex: direction === "horizontal"
                        ? "0 0 calc(100% / ".concat(steps.length, ")")
                        : "0 0 100%",
                }, onClick: function () { return handelStepClick(ind + 1, item); }, children: [jsxRuntime.jsxs("div", { style: {
                            minWidth: "2rem",
                            minHeight: "2rem",
                        }, className: "stepWizard__icon", children: [currentStep > ind + 1 && type === "icon" && jsxRuntime.jsx(Check$1, {}), currentStep === ind + 1 && type === "icon" && jsxRuntime.jsx(Clock$1, {}), type === "number" && ind + 1] }), jsxRuntime.jsxs("div", { className: "stepWizard__body", children: [jsxRuntime.jsx("label", { className: "stepWizard__label", children: item.label }), item.description && (jsxRuntime.jsx("p", { className: "stepWizard__description", children: item.description }))] })] }, ind));
        }) }));
    var forMobile = function () {
        var cStep = currentStep > steps.length ? steps.length : currentStep;
        return (jsxRuntime.jsxs("div", { className: "stepWizard--mobile", children: [jsxRuntime.jsxs("div", { className: "stepWizard__activeStep", children: [jsxRuntime.jsx("div", { className: getClassNames({
                                stepWizard__icon: true,
                                "stepWizard__icon--finish": currentStep > steps.length,
                            }), children: type === "number" ? (cStep) : currentStep > steps.length ? (jsxRuntime.jsx(Check$1, {})) : (jsxRuntime.jsx(Clock$1, {})) }), jsxRuntime.jsxs("div", { className: "stepWizard__body", children: [jsxRuntime.jsx("label", { className: "stepWizard__label", children: steps[cStep - 1].label }), steps[cStep - 1].description && (jsxRuntime.jsx("p", { className: "stepWizard__description", children: steps[cStep - 1].description }))] })] }), jsxRuntime.jsx("ul", { className: "stepWizard--mobile__lineList", children: steps.map(function (i, ind) { return (jsxRuntime.jsx("li", { role: "none", onClick: function () { return handelStepClick(ind + 1, i); }, className: "stepWizard--mobile__line ".concat(currentStep - 1 === ind ? "stepWizard--mobile__line--process" : currentStep - 1 > ind ? "stepWizard--mobile__line--finish" : "stepWizard--mobile__line--wait") }, ind)); }) })] }));
    };
    return jsxRuntime.jsx(jsxRuntime.Fragment, { children: !isMobile ? forDesktop : forMobile() });
};
...
function Switcher(props) {
    ...
    return (jsxRuntime.jsx("div", { className: classnames({
        ...
        }), children: jsxRuntime.jsxs("label", { htmlFor: "Pixel-toggle-".concat(rId), children: [jsxRuntime.jsx("input", { id: "Pixel-toggle-".concat(rId), disabled: isDisabled, "aria-label": "Pixel-toggle-".concat(rId), type: "checkbox", className: "Pixel-toggle", checked: checked, onChange: function () { return onChange === null || onChange === void 0 ? void 0 : onChange(!checked); } }), label && jsxRuntime.jsx("span", { className: "Pixel-toggle__text", children: label })] }) }));
}
...
var Table = function (props) {
    ...
    var _b = React.useState(false), selectAll = _b[0], setSelectAll = _b[1];
    React.useEffect(function () {
    ...
    return (jsxRuntime.jsx("div", { className: "pixel-table__wrapper", children: jsxRuntime.jsxs("table", { className: "pixel-table", role: "table", children: [jsxRuntime.jsx("thead", { children: jsxRuntime.jsxs("tr", { children: [selectable && (jsxRuntime.jsx("td", { className: "pixel-table__heading pixel-table__headingCheckboxCell", children: jsxRuntime.jsx(Checkbox, { onChange: handleSelectAll, checked: selectAll }) })), headings.map(function (ele, ind) {
                                return (jsxRuntime.jsx("th", { className: classnames({
                                    ...
                                    }, children: jsxRuntime.jsxs("div", { className: "flex-row gap-8 justify-between align-center", children: [jsxRuntime.jsx("span", { children: ele.title }), (sortable === null || sortable === void 0 ? void 0 : sortable[ind]) && (jsxRuntime.jsx("span", { className: "flex-row pixel-sortable__icon", children: jsxRuntime.jsxs("svg", { width: "20", height: "20", fill: "none", children: [jsxRuntime.jsx("path", { fill: sortColumnIndex === ind &&
                                                                sortDirection === "descending"
                                                                ? "hsla(227, 100%, 59%, 1)"
                                                                : "hsla(211, 22%, 56%, 1)", d: "M10.59 2.251a.817.817 0 0 0-1.18 0L5.245 6.537a.875.875 0 0 0 0 1.212.817.817 0 0 0 1.179 0L10 4.069l3.577 3.68a.817.817 0 0 0 1.179 0 .874.874 0 0 0 0-1.212L10.589 2.25Z" }), jsxRuntime.jsx("path", { fill: sortColumnIndex === ind &&
                            ...
                            })] }) }), jsxRuntime.jsx("tbody", { children: React.Children.map(children, function (child) {
...
var Row = function (props) {
    ...
    return (jsxRuntime.jsxs("tr", { className: classnames({
            "pixel-table__row": true,
            "pixel-table__row--selected": selected,
        }), id: id, children: [selectable && (jsxRuntime.jsx("td", { className: "pixel-table__cell pixel-table__checkboxCell", children: jsxRuntime.jsx(Checkbox, { onChange: function () {
                        onRowSelection(id);
                    }, checked: selected }) })), children] }));
};
var Cell = function (props) {
    var children = props.children;
    return jsxRuntime.jsx("td", { className: "pixel-table__cell", children: children });
};
Table.Row = Row;
Table.Cell = Cell;
...
var Tabs = function (props) {
    ...
    var _b = React.useState(0); _b[0]; var setKey = _b[1];
    ...
    return (jsxRuntime.jsxs("div", { className: classnames({
        ...
        }), children: [jsxRuntime.jsxs("div", { className: classnames({
                    "pixel-tabs__vertical flex": isVertical,
                }), children: [jsxRuntime.jsx("div", { className: "pixel-tabs__container", children: jsxRuntime.jsx("ul", { "aria-label": "tablist", className: classnames({
                                "pixel-tabs": true,
                                ...
                                return (jsxRuntime.jsxs("li", { role: "none", className: classnames({
                                    ...
                                    }), onClick: function () { return !item.isDisabled && onChange(item.key); }, children: [jsxRuntime.jsxs("div", { className: "pixel-tabs__body", children: [item.icon && (jsxRuntime.jsx("span", { className: "pixel-tabs__icon", children: item.icon })), jsxRuntime.jsx("span", { className: "pixel-tabs__title", children: item.label })] }), item.badge && (jsxRuntime.jsx("div", { className: "pixel-tabs__badge", children: item.badge }))] }, item.label));
                            }) }) }), jsxRuntime.jsx("div", { className: "pixel-tab__border" })] }), jsxRuntime.jsx("div", { className: "pixel-tabs__contentBox", role: "tabpanel", "aria-labelledby": "tab-".concat(value), children: children })] }));
};
...
var Thumbnail = function (_a) {
    ...
    return (jsxRuntime.jsx("div", { className: "thumbnail ".concat(ThumbnailSize, " ").concat(imageFit, " ").concat(onClick && "thumbnail-click"), onClick: onClick, children: jsxRuntime.jsx("img", { className: "thumbnail-img", src: source, alt: alt }) }));
};
...
var Tooltip = function (_a) {
    ...
    var _d = React.useState(false), openState = _d[0], setOpenState = _d[1];
    var _e = React.useState(0), scrollWidth = _e[0], setScrollWidth = _e[1];
    ...
    return (jsxRuntime.jsxs("span", { role: "none", ref: parentRef, className: "Pixel-toolTip", onMouseOver: function () {
            desktopCondition &&
                setOpenState(true);
            ...
            mobileCondition &&
                setOpenState(true);
        }, children: [children, animateData && (jsxRuntime.jsxs(Portal, { children: [jsxRuntime.jsxs("div", { id: "Pixel-toolTip" + rId, role: "tooltip", ref: tooltipRef, style: {
                            position: "fixed",
                            zIndex: zIndex,
                        ...
                        }), children: [jsxRuntime.jsx("span", { ref: pointerRef, className: "Pixel-toolTip__pointer", children: jsxRuntime.jsx("svg", { width: "6", height: "12", viewBox: "0 0 6 12", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: jsxRuntime.jsx("path", { d: "M6 0V12L0 6L6 0Z", fill: "#1c2433" }) }) }), jsxRuntime.jsxs("div", { className: "Pixel-toolTip__message", children: [content, jsxRuntime.jsx("div", { className: "Pixel-toolTip__footer", children: jsxRuntime.jsx("div", { className: "Pixel-toolTip__cancel", onClick: function (e) { e.stopPropagation(); setOpenState(false); }, children: "Ok" }) })] })] }), jsxRuntime.jsx("div", { className: "Pixel-toolTip__overlay" })] }))] }));
};
...
var SkeletonBadge = function (_a) {
    ...
    var ThumbnailSize = checkSize();
    return (jsxRuntime.jsx("div", { className: "skeleton SkeletonBadge ".concat(ThumbnailSize), children: jsxRuntime.jsx("div", { className: "skeleton-inner" }) }));
};
...
var SkeletonButton = function (_a) {
    ...
    var ThumbnailSize = checkSize();
    return (jsxRuntime.jsx("div", { className: "skeleton SkeletonButton ".concat(ThumbnailSize), children: jsxRuntime.jsx("div", { className: "skeleton-inner" }) }));
};
...
var SkeletonCustom = function (_a) {
    ...
    return (jsxRuntime.jsx("div", { className: "skeleton SkeletonCustom", style: { width: width + 'rem', height: height + "rem" }, children: jsxRuntime.jsx("div", { className: "skeleton-inner", style: { borderRadius: radius + 'rem' } }) }));
};
...
var SkeletonLine = function (_a) {
    ...
    return (jsxRuntime.jsx("div", { className: "SkeletonLine", style: { gap: lineGap + 'rem' }, children: Array.from({ length: numberOfLine }, function () { return (jsxRuntime.jsx("div", { className: "skeleton SkeletonLine-item", style: { height: lineHeight + 'rem' }, children: jsxRuntime.jsx("div", { className: "skeleton-inner" }) })); }) }));
};

var SkeletonList = function (_a) {
    //const ThumbnailSize = checkSize();
    var _b = _a.numberOfList, numberOfList = _b === void 0 ? 5 : _b; __rest(_a, ["numberOfList"]);
    return (jsxRuntime.jsx("div", { className: "SkeletonList", children: Array.from({ length: numberOfList }, function () { return (jsxRuntime.jsxs("div", { className: "SkeletonList-item", children: [jsxRuntime.jsx("div", { className: "skeleton SkeletonList-item__thumbnail", children: jsxRuntime.jsx("div", { className: "skeleton-inner" }) }), jsxRuntime.jsx("div", { className: "skeleton SkeletonList-item__content", children: jsxRuntime.jsx("div", { className: "skeleton-inner" }) })] })); }) }));
};

var SkeletonTabs = function (_a) {
    //const ThumbnailSize = checkSize();
    var _b = _a.numberOfTabs, numberOfTabs = _b === void 0 ? 5 : _b; __rest(_a, ["numberOfTabs"]);
    return (jsxRuntime.jsx("div", { className: "SkeletonTabs", children: Array.from({ length: numberOfTabs }, function () { return (jsxRuntime.jsx("div", { className: "skeleton SkeletonTabs-item", children: jsxRuntime.jsx("div", { className: "skeleton-inner" }) })); }) }));
};
...
var SkeletonThumbnail = function (_a) {
    ...
    var ThumbnailSize = checkSize();
    return (jsxRuntime.jsx("div", { className: "skeleton skeletonThumbnail ".concat(ThumbnailSize), children: jsxRuntime.jsx("div", { className: "skeleton-inner" }) }));
};
...
exports.SkeletonCustom = SkeletonCustom;
